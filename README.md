...
## Project Description
### User Experience
 We plan on building a task management application where a user can create and view personal tasks and events. Users will also be able to edit these objects, mark tasks as completed, and schedule them. Additionally, our application helps users visualize and prioritize their tasks by either due date or priority, whichever the user prefers. Lastly, this task scheduler saves the user's data when exiting, and loads this data when opening the application. 
 ### Importance
